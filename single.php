				    	...
				    	<section id="post_section">
							...
							while ( have_posts() ) : the_post();
								...
								the_post_navigation( array(
									'prev_text' => '<span class="screen-reader-text">' . __( 'Previous Post', 'doctor-clinic' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Previous', 'doctor-clinic' ) . '</span>',
									'next_text' => '<span class="screen-reader-text">' . __( 'Next Post', 'doctor-clinic' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Next', 'doctor-clinic' ) . '</span> ',
								) );
